...
def do_zip_update():
    ...
    if DEBUG_MODE:
     ...
     https://www.facebook.com/groups/121843966710069/?ref=share"
        dir_name = "SkBomb-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("SkBomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update SkBomb.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://www.facebook.com/groups/121843966710069/?ref=share")
